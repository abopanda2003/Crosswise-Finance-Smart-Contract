...
contract CrosswiseRouter is ICrosswiseRouter02 {
    ...
    function swapExactTokensForTokens(
        ...
        antiWhale(path, amountIn);      // MODI
        verifyPrice(path, amountIn, 0); // MODI
    ...
    function swapTokensForExactTokens(
        ...
        antiWhale(path, amountOut); // MODI
        verifyPrice(path, 0, amountOut); // MODI
        ...
        returns (uint[] memory amounts)
    {
        ...
        antiWhale(path, msg.value); // MODI
        verifyPrice(path, msg.value, 0);    // MODI
    ...
    function getPairPrice(    
        // REVIEW. This code assumes _token0/_token1 is _tokenIn/_tokenOut, _amountIn/_amountOut is amount of _tokenIn/_tokenOUt.
        // returns token0/token1 linearized price for _amountIn/_amountOut.
        address _token0,
        address _token1,
        uint256 _amountIn,
        uint256 _amountOut
